...
//             <div className="flex items-center justify-center w-52 h-52 rounded-full dark:bg-default-600">
//               {/* image */}
  ...
  return (
    <div>
      ...
      <hr className="border-gray-600" />
          <div className="text-center w-full bg-primary text-secondary text-sm py-2">© Copyright 2024 Braille  - All Rights Reserved</div>
    </div>
  );
}
