...
function Cart() {
  ...
  return (
    <Container>
      <div className="bg-white divide-y divide-gray-300 px-4 mx-auto w-full min-h-screen md:max-w-[85%] lg:max-w-[80%]">
          ...
          return (
            <div className="grid md:grid-cols-5  items-center gap-4 py-4">
              <div className="col-span-3 flex items-center gap-6 ">
                ...
                <div>
                  <h3
                    className="text-base md:text-lg font-bold text-gray-800 h-12 md:h-14 overflow-hidden"
