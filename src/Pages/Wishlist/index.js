...
function WishList() {
  ...
  return (
    <Container>
      <div className="bg-white divide-y divide-gray-300 px-4 mx-auto md:max-w-[85%] lg:max-w-[80%] min-h-screen">
        <h1 className="text-3xl underline text-center font-bold p-5 italic lg:text-5xl">
          Wishlist
        </h1>
        {/*  */}
        {items.map((item) => {
          return (
            <div className="grid md:grid-cols-5  items-center gap-4 py-4">
              <div className="col-span-3 flex items-center gap-6 ">
                ...
                <div>
                  <h3
                    className="text-base md:text-lg xlg:text-xl font-bold text-gray-800 h-12 md:h-14 overflow-hidden"
              ...
              <h4 className="text-lg font-bold text-gray-800 md:text-lg lg:text-xl">
                ${item.price}
              </h4>
